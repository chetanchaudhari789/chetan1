...
const data: I_About[] = [
  ...
  },
  {
    year: 2021,
    events: [
      "Graduated high school with 77.50%, motivated to pursue engineering and dive deeper into tech. 🎓",
  ...
  },
  {
    year: 2019,
    events: [
      "Completed 10th grade with 67.66%, and became increasingly curious about technology and digital systems. 📘",
